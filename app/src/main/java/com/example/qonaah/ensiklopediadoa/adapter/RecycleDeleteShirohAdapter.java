...
public class RecycleDeleteShirohAdapter extends RecyclerView.Adapter<RecycleDeleteShirohAdapter.MyViewHolder> {

    private List<Shiroh> shirohs;
    private onClickListener onClickListener;

    public RecycleDeleteShirohAdapter(List<Shiroh> shirohs) {this.shirohs = shirohs;
    }
