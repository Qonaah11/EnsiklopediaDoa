...
public class RecyclerDeleteNamaAdapter extends RecyclerView.Adapter<RecyclerDeleteNamaAdapter.MyViewHolder> {

    private List<Nama> namas;
    private onClickListener onClickListener;

    public RecyclerDeleteNamaAdapter(List<Nama> namas) {
        this.namas = namas;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ubah_nama, parent, false);
