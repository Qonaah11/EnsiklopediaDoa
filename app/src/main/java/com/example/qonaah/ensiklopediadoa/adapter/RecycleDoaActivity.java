...
public class RecycleDoaActivity extends RecyclerView.Adapter<RecycleDoaActivity.MyViewHolder> {

    private List<Hari> haris;
    private onClickListener onClickListener;

    public RecycleDoaActivity(List<Hari> haris) {
        this.haris = haris;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.textViewNamaDua.setText(hari.getNama());
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView textViewNamaDua;

        public MyViewHolder(View view) {
            super(view);
            textViewNamaDua = (TextView) view.findViewById(R.id.text_nama_doa);
